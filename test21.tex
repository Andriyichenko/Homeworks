...
\begin{frame}
    ...
    \begin{figure}[htpb]
        \begin{center}
            \includegraphics[keepaspectratio, scale=0.017]{/Users/andriyichenko/Documents/VScode/Latex/pic/Ritsumeikan_University_Logo.png}
        \end{center}
    \end{figure}
\end{frame}
...
%           \psRotation{25}(-1.2,2.6){$\dot\psi$}
    ...
    \begin{minipage}{0.5\linewidth}
        ...
        \begin{figure}[h]
            \centering
            \includegraphics[height=.4\textheight]{/Users/andriyichenko/Documents/VScode/Latex/pic/sample.pdf}
        \end{figure}
    \end{minipage}
\end{frame}
