...
\draw[fill=white, draw=black, line width=0.5pt] (0.13,0.78) node[left=0.2em]{\small 2} node[above right=1.5em]{\small 図1} node[above=5em]{\small 「\;\begin{tikzpicture}[scale=0.1]
\fill[white] circle[radius=1];
\draw[black, line width=0.5pt] circle[radius=1]; % 添加白色描边
\end{tikzpicture}\ =\ 0
,\; \begin{tikzpicture}[scale=0.1]
\fill[black] circle[radius=1];
\draw[black, line width=0.5pt] circle[radius=1]; % 添加白色描边
\end{tikzpicture}\ =\ 1」を表す} circle (2pt);
